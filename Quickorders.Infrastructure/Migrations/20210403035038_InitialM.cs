        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberId = table.Column<string>(type: "varchar(767)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerId = table.Column<string>(type: "varchar(767)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Restaurants", x => x.Nit);
                    table.ForeignKey(
                        name: "FK_Restaurants_Owner_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Title = table.Column<string>(type: "varchar(767)", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    RestaurantNit = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Menus", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Menus_Restaurants_RestaurantNit",
                        column: x => x.RestaurantNit,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Menus_RestaurantNit",
                table: "Menus",
                column: "RestaurantNit");

            migrationBuilder.CreateIndex(
                name: "IX_Menus_Title_RestaurantNit",
                table: "Menus",
                columns: new[] { "Title", "RestaurantNit" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Name_MenuId",
                table: "Products",
                columns: new[] { "Name", "MenuId" },
                unique: true);
